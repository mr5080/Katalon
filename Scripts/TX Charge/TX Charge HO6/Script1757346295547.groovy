...
try {
	...
	if (validationText.contains('ineligible'))
	{
	  ...
	  WebUI.takeScreenshot(('C:\\Users\\JohnHughes\\OneDrive - CORNERSTONE OPERATIONS GROUP\\ProjectFiles\\CypressScreenShots\\' + todaysTimeStamp + '-' + quoteNumber) + 'TX Charge HO6 Failure - Validation.jpg')
	}
	else
		{
...
catch(e)
{
	...
	quoteNumber = quoteNumber.replace(':', '')
	WebUI.takeScreenshot(('C:\\Users\\JohnHughes\\OneDrive - CORNERSTONE OPERATIONS GROUP\\ProjectFiles\\CypressScreenShots\\' + todaysTimeStamp + '-' + quoteNumber) + 'TX Charge HO6 Failure.jpg')
