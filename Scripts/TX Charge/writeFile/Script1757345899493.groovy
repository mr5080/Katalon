...
FileInputStream file = new FileInputStream(new File('C:\\Users\\JohnHughes\\OneDrive - CORNERSTONE OPERATIONS GROUP\\ProjectFiles\\CypressTXCharge.xlsx'))
...
/*		if(shouldBind == false)
	...
	//		sheet.getRow(rowCount).createCell(7).setCellValue(totalPremium)
			...
			try {
				FileOutputStream outFile = new FileOutputStream(new File('C:\\Users\\JohnHughes\\OneDrive - CORNERSTONE OPERATIONS GROUP\\ProjectFiles\\CypressTXCharge.xlsx'))
