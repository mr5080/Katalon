...
Object addressData = ExcelFactory.getExcelDataWithDefaultSheet('C:\\Users\\john.hughes\\Documents\\ProjectFiles\\Editable Claim Cases - Copy.xlsx', 'Sheet1', true)

//int randomLAaddress = 2 + ((Math.random() * ((110 - 2) + 1)) as int)
int randomLAaddress = 9
...
String addressLA = addressData.getValue(23, randomLAaddress).toUpperCase() + " " + addressData.getValue(24, randomLAaddress).toUpperCase() + " " + addressData.getValue(25, randomLAaddress).toUpperCase()

String cityLA = addressData.getValue(27, randomLAaddress).toUpperCase()

String stateLA = addressData.getValue(28, randomLAaddress).toUpperCase()

String zipLA = addressData.getValue(29, randomLAaddress)
...
//Object firstNameData = ExcelFactory.getExcelDataWithDefaultSheet('C:\\Users\\john.hughes\\Documents\\ProjectFiles\\LA-EvergreenData.xlsx',	'FirstName', false)

int randomFirstNameRow = randomLAaddress //1 + ((Math.random() * ((835 - 1) + 1)) as int)

System.out.println(randomFirstNameRow)

String randomFirstName = addressData.getValue(6, randomFirstNameRow)
...
int randomLastNameRow = randomLAaddress  //1 + ((Math.random() * ((900 - 1) + 1)) as int)

System.out.println(randomLastNameRow)

//String randomLastName = lastNameData.getValue(1, randomLastNameRow).replaceAll("\\d","")
String randomLastName = addressData.getValue(5, randomLastNameRow)
...
String DOB = addressData.getValue(12, randomLastNameRow)

System.out.println("DOB from excel file = " + DOB )



String convertedMonth = DOB.substring(5, 6)
if(convertedMonth.length() < 2)
{
	convertedMonth = "0" + convertedMonth
}
System.out.println("convertedMonth = " + convertedMonth)
System.out.println("DOB from excel file = " + DOB )


String convertedDay = DOB.substring(6, 8)
System.out.println("convertedDay FIRST = " + convertedDay)

System.out.println("convertedDay.length() = " + convertedDay.length() )
if(convertedDay.length() < 2)
{
	convertedDay = "0" + convertedDay
}
System.out.println("convertedDay = " + convertedDay)
System.out.println("DOB from excel file = " + DOB )


String convertedYear = DOB.substring(0, 4)
System.out.println("convertedYear = " + convertedYear)


String convertedDOB = convertedMonth + "/" + convertedDay+ "/" + convertedYear
System.out.println("convertedDOB = " +convertedDOB)
...
if (WebUI.waitForElementVisible(findTestObject('Object Repository/LA-Evergreen2/Page_/div_QuoteNumber'), 30)) // works!
{
...
for(int x = 0; x < 10; x++)
{
	try 
	{
	    ...
	    WebUI.setText(findTestObject('Object Repository/LA-Evergreen2/Page_/input_SearchAgentCode'), '18210')
...
WebUI.setText(findTestObject('LA-Evergreen2/Page_/input_Applicant Date of Birth_ApplicantBirth'), convertedDOB)
...
String applicantSex = addressData.getValue(13, randomLAaddress - 1).toUpperCase()
System.out.println("applicantSex = " + applicantSex)

/*
int optionsCount = WebUI.getNumberOfTotalOption(findTestObject('Object Repository/LA-Evergreen2/Page_/select_MaleFemale'))

System.out.println('optionsCount = ' + optionsCount)
for (int i = 0; i < optionsCount; i++) {
	WebUI.selectOptionByIndex(findTestObject('Object Repository/LA-Evergreen2/Page_/select_MaleFemale'), i)

	// outputs dropdown label
	selectedOption = WebUI.getAttribute(findTestObject('Object Repository/LA-Evergreen2/Page_/select_MaleFemale'), 'value').toUpperCase()
	System.out.println('selectedOption = ' + selectedOption)
}
*/
...
else
{
	...
	WebUI.selectOptionByValue(findTestObject('Object Repository/LA-Evergreen2/Page_/select_MaleFemale'), 'F', true)
}
...
WebUI.selectOptionByValue(findTestObject('LA-Evergreen2/Page_/select_Closed Foundation up to 6Open Founda_1'), 'CLOSEDF',    true)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/LA-Evergreen2/Page_/select_CopperAluminumClothKnob and TubeOther'),  'COPPER', true)
