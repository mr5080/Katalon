...
//String temp = WebUI.getText(By.xpath('//label'));
...
WebUI.click(findTestObject('Object Repository/Page_EZLynx - Home Page/span_LECOMPTE DAVID'))
...
if (WebUI.waitForElementPresent(findTestObject('Object Repository/Page_VU CHARLES - Quote Details/span_Quoted by'), 30)) {
    ...
    String myText = WebUI.getAttribute(findTestObject('Object Repository/Page_VU CHARLES - Quote Details/span_Quoted by'), 'value')
