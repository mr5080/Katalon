...
WebUI.click(findTestObject('Object Repository/TX Evergreen HO3/Page_/li_Start a New Quote'))
...
WebUI.setText(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_Effective Date_EffectiveDate'), effectiveDate)

WebUI.selectOptionByValue(findTestObject('Object Repository/TX Evergreen HO3/Page_/select_FLORIDATEXAS'), '42', true)

WebUI.setText(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_First Name_ApplicantFirst'), randomFirstName)

WebUI.setText(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_Last Name_ApplicantLast'), randomLastName)
...
*/
WebUI.setText(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_Address_ApplicantAddress1'), addressTX)
WebUI.setText(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_City_ApplicantCity'), cityTX)
WebUI.setText(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_Property Zip Code_ApplicantZip'), zipTX)

WebUI.sendKeys(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_Property Zip Code_ApplicantZip'), Keys.chord(Keys.TAB))
...
WebUI.setText(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_Purchase Date_PurchaseDate_1'), '10/14/2019')
...
// 2 new questions?
WebUI.click(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_Yes_NOSAVEUnsettledClaim'))
WebUI.click(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_Yes_NOSAVELawsuit'))
...
WebUI.setText(findTestObject('Object Repository/TX Evergreen HO3/Page_/input_Authorized User Agreement_RecurPayAuthorize'), randomLastName)
